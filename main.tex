...
categories, the notion of co-closer, and finally, the definition of
...
definition describes when a symmetric monoidal category is co-closed.
\begin{definition}
  \label{def:SMCC}
  A \textbf{symmetric monoidal co-closed category (SMCCC)} is a symmetric
...
\begin{definition}
  ...
  is closed, and $(\cat{M}, \perp, \oplus)$ is co-closed.  We will
...
% subsection cartesian_closed_and_co-cartesian_co-closed_categories (end)
