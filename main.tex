...
\newcommand{\func}[1]{\mathop{\mathsf{#1}}}
...
\newcommand{\j}[1]{\mathop{\mathsf{j}_{#1}}}
...
\begin{proof}
  ...
  \begin{array}{lll}
    ...
    \c{A} := \wn A \oplus \wn A = \func{JH}A \oplus \func{JH}A \mto^{\j{\func{H}A,\func{H}A}} \func{J}(\func{H}A + \func{H}A) \mto^{\func{J}[\id_A,\id_A]} \func{JHA} = \wn A
  \end{array}
  \]
  ...
  \item[Case.] The functor $\func{C} : \cat{L} \mto \cat{L}$ is indeed
    ...
    \small
    \begin{array}{lll}
      \quad\quad\quad\t_\perp := \perp \mto^{\j{\perp}} \func{J}0 \mto^{\func{J}\diamond_{\func{H}\perp + \func{H}\perp}} \func{J}(\func{H}\perp + \func{H}\perp) \mto^{\j{\func{H}\perp,\func{H}\perp}} \wn \perp \oplus \wn \perp
      \\
